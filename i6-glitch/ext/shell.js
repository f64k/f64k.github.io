                        ...
                        { text: 'Открыть папку',
                          handler: function (t) {
                              ...
                              fileSelector.onchange = function(e) {
                                  ...
                                  Ext.toast('_files.length='+_files.length);
                                  if (fileSelector.multiple == true) { // для выбора каталога может быть false
                                      for (var i = 0, len = _files.length; i < len; i++) { // loop files
                                          var file = _files.item(i);
                                      }
                                  } else { // only one file available
									  var file = _files.item(0);
                                  }
                              };
                              fileSelector.click();
                          }
